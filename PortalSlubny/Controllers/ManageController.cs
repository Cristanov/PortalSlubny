    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.ChangeEmailSuccess ? "Twój email został zmieniony"
        ...
        {
            string currentUserEmail = UserManager.FindById(User.Identity.GetUserId()).Email;
            ChangeEmailViewModel model = new ChangeEmailViewModel(currentUserEmail);
            return View(model);
        }
